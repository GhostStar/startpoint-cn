...
| F1045 惊险池 Tag + 测试种子 | Tag 三态（热血/普通/冷血），测试种子每稀有度1个，三栏横向 Web UI，净化池不降级 |
| TODO | 测试池模式时游戏内发公告提醒 "种子测试模式，可能出现动画异常" |
| ✅ 种子池 | C3032 自动净化收敛，惊险种子 21 个（★3:8 ★4:8 ★5:5），服务器默认净化池，零 C3032 |
